...
if not exist "%VENV_DIR%\Scripts\pip.exe" (echo   [FAIL]  Venv not found. Run START_OncoCare_AI.bat first. & pause & exit /b 1)
...
echo   [ OK ]  All packages updated. Restart OncoCare AI to apply.
echo.
pause
