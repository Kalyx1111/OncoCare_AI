...
if "%PIP%"=="" (echo   [FAIL]  pip not found. Run START_OncoCare_AI.bat first. & pause & exit /b 1)
...
echo.
echo  ================================================================
echo   DONE. OncoCare AI now works WITHOUT internet connection.
echo   Run START_OncoCare_AI.bat to launch.
echo  ================================================================
echo.
pause
